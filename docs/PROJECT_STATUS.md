...
- 最近牌局：大厅工具栏的时钟图标点开，列出本人参与过的最近 20 手。**不是录像式回放**，而是一屏读完的牌谱：盈亏、公共牌（发两次分两行）、各家座位与筹码变化、按街的动作过程；对手盖着结束的牌显示「未亮牌」。牌面与牌桌共用四色和自绘花色。
