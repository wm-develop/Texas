...
当前源码基线为 `v0.7.0`。账户筹码、PostgreSQL 持久化、管理治理和单实例生产部署链路均已落地，项目已具备可供熟人联机使用的完整功能：
...
- 最近牌局：列出本人参与过的最近 20 手，含公共牌、各家筹码变化与按街的动作过程；对手盖着结束的牌显示「未亮牌」。另有结算历史、追加式筹码账本、基础设置、轻量牌桌动画，以及下注、All in、过牌和弃牌的独立牌桌音效。
