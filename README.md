...
当前源码基线为 `v0.4.3`，`0.5.0` 正在开发中（牌局跨重启恢复、登录态持久化已合入 `main`，尚未发版）。账户筹码、PostgreSQL 持久化、管理治理和单实例生产部署链路均已落地，项目已具备可供熟人联机使用的完整功能：
...
- **每个版本改了什么、升级时要注意什么**，见发布说明：[v0.4.3](docs/releases/v0.4.3.md) · [v0.4.2](docs/releases/v0.4.2.md) · [v0.3.0](docs/releases/v0.3.0.md) · [v0.2.1](docs/releases/v0.2.1.md) · [v0.2.0](docs/releases/v0.2.0.md) · [v0.1.1](docs/releases/v0.1.1.md) · [v0.1.0](docs/releases/v0.1.0.md)。
